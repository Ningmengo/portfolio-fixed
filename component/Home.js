    ...
    <div className={isActive ? "App-lightTheme" : "App"}>
      ...
      <div className="Contact">
        <div className="container">
          <a href="https://www.instagram.com/koreyos220/">
            <svg
              className="ins"
          ...
          <a href="https://discord.com/channels/%E4%B8%8D%E6%98%AFningmeng">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="100"
              height="100"
          ...
          <a href="weixin://dl/chat?Ninmengo">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="100"
              height="100"
          ...
          <a href="https://github.com/Ningmengo">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="100"
              height="100"
